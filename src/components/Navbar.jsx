  ...
  useEffect(() => {
  if (locationName && locationName !== "Detecting...") {
    ...
    useEffect(() => {
      ...
      area.toLowerCase().includes(a.toLowerCase().split(",")[0])
        ...
        return (
<header className="w-full bg-white shadow-sm border-b border-gray-100 fixed top-0 left-0 z-50">            {/* Navbar Container */}
  <div className="max-w-7xl mx-auto flex items-center justify-between px-4 md:px-8 py-3 h-16 md:h-20">
